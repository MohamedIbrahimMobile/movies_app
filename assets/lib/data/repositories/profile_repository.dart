...
class ProfileRepository {
  ...
  Future<void> addMovieToWatchList(Movie movie) {
    return _firestoreService.addMovieToWatchList(userId: _userId, movie: movie);
  }
  ...
  Future<void> addMovieToHistory(Movie movie) {
    return _firestoreService.addMovieToHistory(userId: _userId, movie: movie);
  }

  Future<bool> isMovieInHistory(int movieId) {
    return _firestoreService.isMovieInHistory(
      userId: _userId,
      movieId: movieId,
    );
  }
