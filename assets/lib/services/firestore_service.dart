...
class FirestoreService {
  ...
  Future<void> addMovieToWatchList({
    ...
    await _watchListCollection(userId).doc(movie.id.toString()).set({
      'movie': movie.toJson(),
  ...
  Future<void> removeMovieFromWatchList({
    ...
    await _watchListCollection(userId).doc(movieId.toString()).delete();
  }
  ...
  Future<void> addMovieToHistory({
    ...
    await _historyCollection(userId).doc(movie.id.toString()).set({
      'movie': movie.toJson(),
      'visitedAt': FieldValue.serverTimestamp(),
    });
  }

  Future<bool> isMovieInHistory({
    required String userId,
    required int movieId,
  }) async {
