...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
      ...
      child: BlocConsumer<AuthBloc, AuthState>(
        listener: (context, state) {
          ...
          if (state is UpdateProfileSuccess) {
            DialogUtils.showToast(message: 'profile_updated_success'.tr());
            Navigator.pop(context);
          }
          if (state is DeleteAccountSuccess) {
            DialogUtils.showToast(message: 'account_deleted_success'.tr());
  ...
  void updateAccount(BuildContext innerContext) {
    ...
    DialogUtils.showMessage(
      context: innerContext,
      title: 'update_data'.tr(),
      message: 'update_account_confirm_message'.tr(),
      posActionName: 'ok'.tr(),
      posAction: () {
